...
namespace UI {
    // Ładuje czcionkę z pełnym wsparciem to glifów polskich
    inline Font LoadStandardFont(int fontSize) {
        ...
        return LoadFontEx("fonts/Ranchers-Regular.ttf", fontSize, codepoints, 95 + 18);
    }

    // Rysuje teksturę jako powtarzające się tło
    ...
    // Rysuje standardowy przycisk menu
